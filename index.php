...
<h2 class="title-product">Cara Order</h2>
  <div class="row">
    <div class="col-sm-3 col-xs-6" style="padding-top:20px">
      <i class="fas fa-user logo-small"></i>
      <h4 style="margin-bottom:5px">Login</h4>
    </div>
    <div class="col-sm-3 col-xs-6" style="padding-top:20px">
      <i class="fas fa-shopping-cart logo-small"></i>
      <h4 style="margin-bottom:5px">Pilih Produk Yang Anda Inginkan</h4>
    </div>
    <div class="col-sm-3 col-xs-6" style="padding-top:20px">
      <i class="far fa-check-square logo-small"></i>
      <h4 style="margin-bottom:5px">Checkout</h4>
    </div>
    <div class="col-sm-3 col-xs-6" style="padding-top:20px">
      <i class="far fa-credit-card logo-small"></i>
      <h4 style="margin-bottom:5px">Transfer</h4>
      <p></p>
    </div>
  </div>
</div>
...
<div id="shop" class="container-fluid">
  <h2 class="title-product">Shop</h2>
  <div class="row">
